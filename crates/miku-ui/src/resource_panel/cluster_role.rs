...
#[derive(Clone, Debug)]
pub(crate) struct ClusterRoleResourcePanel {
    inner: AccessControlResourcePanel,
}

impl Default for ClusterRoleResourcePanel {
    fn default() -> Self {
        Self {
            inner: AccessControlResourcePanel::new(AccessControlResourceKind::ClusterRole),
        }
    }
}

impl ClusterRoleResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
