...
#[derive(Clone, Debug)]
pub(crate) struct RuntimeClassResourcePanel {
    inner: ConfigResourcePanel,
}

impl Default for RuntimeClassResourcePanel {
    fn default() -> Self {
        Self {
            inner: ConfigResourcePanel::new(ConfigResourceKind::RuntimeClass),
        }
    }
}

impl RuntimeClassResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
