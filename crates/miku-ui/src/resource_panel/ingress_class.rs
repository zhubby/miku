...
#[derive(Clone, Debug)]
pub(crate) struct IngressClassResourcePanel {
    inner: NetworkResourcePanel,
}

impl Default for IngressClassResourcePanel {
    fn default() -> Self {
        Self {
            inner: NetworkResourcePanel::new(NetworkResourceKind::IngressClass),
        }
    }
}

impl IngressClassResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
