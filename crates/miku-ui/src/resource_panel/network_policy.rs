...
#[derive(Clone, Debug)]
pub(crate) struct NetworkPolicyResourcePanel {
    inner: NetworkResourcePanel,
}

impl Default for NetworkPolicyResourcePanel {
    fn default() -> Self {
        Self {
            inner: NetworkResourcePanel::new(NetworkResourceKind::NetworkPolicy),
        }
    }
}

impl NetworkPolicyResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
