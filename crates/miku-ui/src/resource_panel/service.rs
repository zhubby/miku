...
#[derive(Clone, Debug)]
pub(crate) struct ServiceResourcePanel {
    inner: NetworkResourcePanel,
}

impl Default for ServiceResourcePanel {
    fn default() -> Self {
        Self {
            inner: NetworkResourcePanel::new(NetworkResourceKind::Service),
        }
    }
}

impl ServiceResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
