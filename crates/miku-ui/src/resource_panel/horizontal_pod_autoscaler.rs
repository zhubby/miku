...
#[derive(Clone, Debug)]
pub(crate) struct HorizontalPodAutoscalerResourcePanel {
    inner: ConfigResourcePanel,
}

impl Default for HorizontalPodAutoscalerResourcePanel {
    fn default() -> Self {
        Self {
            inner: ConfigResourcePanel::new(ConfigResourceKind::HorizontalPodAutoscaler),
        }
    }
}

impl HorizontalPodAutoscalerResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
