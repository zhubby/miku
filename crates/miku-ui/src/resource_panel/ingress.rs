...
#[derive(Clone, Debug)]
pub(crate) struct IngressResourcePanel {
    inner: NetworkResourcePanel,
}

impl Default for IngressResourcePanel {
    fn default() -> Self {
        Self {
            inner: NetworkResourcePanel::new(NetworkResourceKind::Ingress),
        }
    }
}

impl IngressResourcePanel {
    pub(crate) fn show(
        &mut self,
        ui: &mut egui::Ui,
